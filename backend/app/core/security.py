...
ENDPOINT_RULES: tuple[EndpointRule, ...] = (
    EndpointRule("GET", "/ops/regional-price-snapshot-labels/preview", "admin", "level_1"),
    ...
    EndpointRule("POST", "/ops/regional-price-snapshot-labels/execute", "admin", "level_1"),
    ...
    EndpointRule("POST", "/catalog/import/stage", "admin", "level_1"),
    EndpointRule("POST", "/catalog/import/commit", "admin", "level_1"),
    EndpointRule("DELETE", "/catalog/import/staged", "admin", "level_1"),
    EndpointRule("GET", "/catalog/import/staged", "analyst", "level_0"),
    ...
    EndpointRule("POST", "/catalog/canonical/enrich-specs", "admin", "level_1"),
    EndpointRule("POST", "/catalog/canonical/link-market-evidence", "admin", "level_1"),
    EndpointRule("POST", "/catalog/spec-audit/run", "admin", "level_1"),
    EndpointRule("GET", "/catalog/spec-audit/report", "admin", "level_1"),
    EndpointRule("GET", "/catalog/spec-audit/products", "admin", "level_1"),
